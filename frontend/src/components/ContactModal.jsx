      ...
      >
        ...
        {status === "success" ? (
          ...
          >
            ...
            >
              Your message has been received by our atelier team. We will
            ...
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "var(--kernia-obsidian)")
              }
            >
              Close
            </button>
          ...
          <>
            ...
            <div style={{ marginBottom: "2.5rem", paddingTop: "1rem" }}>
              ...
              >
                Whether you have a question about a piece, a bespoke request, or
                simply wish to connect — we are here.
              </p>
            </div>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onBlur={(e) =>
                      (e.target.style.borderColor = errors.senderName
                        ? "#c0392b"
                        : "rgba(5,5,5,0.15)")
                    }
                  />
                  {errors.senderName && (
                    <span style={errStyle}>{errors.senderName}</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onBlur={(e) =>
                      (e.target.style.borderColor = errors.senderEmail
                        ? "#c0392b"
                        : "rgba(5,5,5,0.15)")
                    }
                  />
                  {errors.senderEmail && (
                    <span style={errStyle}>{errors.senderEmail}</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onBlur={(e) =>
                      (e.target.style.borderColor = "rgba(5,5,5,0.15)")
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.message && (
                    <span style={errStyle}>{errors.message}</span>
                  )}
                </div>
