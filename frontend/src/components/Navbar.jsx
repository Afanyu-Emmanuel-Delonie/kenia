  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        gap: "0.75rem",
        boxShadow: "0 8px 32px rgba(5,5,5,0.2)",
    ...
    >
      ...
      >
        <strong style={{ color: "#B68D40" }}>{label}</strong> is not available
        yet
      </p>
      <button
        onClick={onClose}
...
export default function Navbar() {
  ...
  const dividerBg =
    !isMenuOpen && scrolled ? "rgba(5,5,5,0.12)" : "rgba(255,255,255,0.2)";
    ...
    <>
      <nav
        style={{
          ...
          right: 0,
          background:
            !isMenuOpen && scrolled ? "rgba(252,252,250,0.97)" : "transparent",
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1.4rem" }}>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.color = "var(--kernia-gold)")
              }
              onMouseLeave={(e) =>
            ...
            <button
              onClick={() => setUnavailable("Wishlist")}
              aria-label="Wishlist"
            ...
            >
              ...
              <span
                style={{
                  ...
                  top: "-5px",
                  right: "-6px",
                  background: onDark ? "#FCFCFA" : "#050505",
                  color: onDark ? "#050505" : "#FCFCFA",
                  fontFamily: "var(--font-data)",
                  fontSize: "0.42rem",
                  fontWeight: 700,
                  width: "12px",
        ...
        >
          {navLinks.map(({ label }, i) => (
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.color = "var(--kernia-ivory)")
              }
            >
              {label}
            </button>
        ...
        <div style={{ display: "flex", gap: "2.5rem", flexWrap: "wrap" }}>
          {[
            ...
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.color = "rgba(252,252,250,0.45)")
              }
            >
              {label}
            </button>
